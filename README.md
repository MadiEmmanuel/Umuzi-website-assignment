...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center style=color:blue;" id="home">
    ...
    <p>Data Scientist.</p>
    <img src="IMG_20170915.jpg" alt="Avatar" class="w3-center w3-circle w3-margin-right " style="width:220px" >		
  </header>
<!-- About Section -->
  ...
  <div class="w3-padding-64 w3-content w3-text-grey" id="contact">
	...
	<p><i class="fa fa-map-marker fa-fw w3-text-white w3-xlarge w3-margin-centre"/i> Wattville, Benoni /p>
	<p><i class="fa fa-phone fa-fw w3-text-white w3-xlarge w3-margin-centre"/i>Phone: 073 8028 772 /p>
	<p><i class="fa fa-envelope fa-fw w3-text-white w3-xlarge w3-margin-centre"/i>Email:emmanel.madi@umuzi.org /p>
