...
<!-- About Section -->
  ...
  <div class="w3-padding-64 w3-content w3-text-grey" id="contact">
	...
	<p><i class="fa fa-map-marker fa-fw w3-text-white w3-xlarge w3-margin-centre"> Wattville, Benoni /p>
	<p><i class="fa fa-phone fa-fw w3-text-white w3-xlarge w3-margin-centre">Phone: 073 8028 772 /p>
	<p><i class="fa fa-envelope fa-fw w3-text-white w3-xlarge w3-margin-centre">Email:emmanel.madi@umuzi.org /p>
